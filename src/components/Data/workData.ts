...
const workData: WorkDataItem[] = [
  {
    ...
    content: `## Digital artwork and motion, built for production.\n\nAs a Digital Artworker at McCann Manchester, I create high-volume digital and motion content for national brands across all kinds of platforms. A lot of my work is about finding the sweet spot between speed and craft — turning static ideas into polished motion, managing loads of versions, and using AI and automation to make tricky production jobs a little easier.\n\n
From building custom agents to speed up email builds, to creating data-driven workflows for high-volume animation, I'm always looking for smarter ways to get things made without compromising on quality, accessibility or brand accuracy.\n\n
Here's a quick look at some of the production work I've been involved in, featuring Aldi, Warburtons and McCain.
   \n\n<div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/1163431980?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media; web-share" referrerpolicy="strict-origin-when-cross-origin" style="position:absolute;top:0;left:0;width:100%;height:100%;" title="Ben Bayliss Artworker examples"></iframe></div><script src="https://player.vimeo.com/api/player.js"></script> 
