    ...
    <div className="inner-page">
      ...
      <p>
        <img
          ...
          src="/src/assets/images/misterben_benandi_front.jpg"
      ...
      <p>
        <img
          className="inner-page__image"
          src="/src/assets/images/misterben_benandi_inner.jpg"
          alt="Misterben benandi album design"
        />
      </p>
      ...
      <p>
        <img
          className="inner-page__image"
          src="/src/assets/images/misterben_benandi_closeup.jpg"
          alt="Misterben benandi album design"
        />
      </p>
      ...
      <p>
        <img
          className="inner-page__image"
          src="/src/assets/images/misterben_benandi_closeup-inner.jpg"
          alt="Misterben benandi album design"
        />
      </p>
      ...
      <p>
        <img
          className="inner-page__image"
          src="/src/assets/images/misterben_benandi2.jpg"
          alt="Misterben benandi album design"
        />
      </p>
      ...
      <p>
        <img
          className="inner-page__image"
          src="/src/assets/images/misterben_album_idea.jpg"
          alt="Misterben benandi album design"
        />
      </p>
