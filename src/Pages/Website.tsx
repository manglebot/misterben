    ...
    <div className="inner-page">
      ...
      <div className="inner-page__content">
        ...
        <p>
          <img
            className="inner-page__image"
            src="/images/bspoke_concept_2019+drawing.jpg"
        ...
        <p>
          <img
            className="inner-page__image"
            src="/images/rune_concepts.png"
            alt="Rune Creative's B'spoke Coffee website concept"
            // className="caption"
          />
          <img
            className="inner-page__image"
            src="/images/rune_header_idea.png"
        ...
        <p>
          <img
            className="inner-page__image"
            src="/images/bspoke_layout_ideas.jpg"
        ...
        <p>
          <img
            className="inner-page__image"
            src="/images/bspoke_homepage.jpg"
