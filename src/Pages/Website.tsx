    ...
    <div className="inner-page">
      ...
      <div className="inner-page__content">
        ...
        <p>
          <img
            className="inner-page__image"
            src="/src/assets/images/bspoke_concept_2019+drawing.jpg"
        ...
        <p>
          <img
            className="inner-page__image"
            src="/src/assets/images/bspoke_xmas.jpg"
        ...
        <p>
          <img
            className="inner-page__image"
            src="/src/assets/images/rune_concepts.png"
            alt="Rune Creative's B'spoke Coffee website concept"
            // className="caption"
          />
          <img
            className="inner-page__image"
            src="/src/assets/images/rune_header_idea.png"
        ...
        <p>
          <img
            className="inner-page__image"
            src="/src/assets/images/bspoke_layout_ideas.jpg"
        ...
        <p>
          <img
            className="inner-page__image"
            src="/src/assets/images/bspoke_header.png"
        ...
        <p>
          <img
            className="inner-page__image"
            src="/src/assets/images/bspoke_homepage.jpg"
        ...
        <p>
          <img
            className="inner-page__image"
            src="/src/assets/images/bspoke_footer.jpg"
