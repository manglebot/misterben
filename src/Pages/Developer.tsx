    ...
    <div className="inner-page">
      ...
      <div className="inner-page__content">
        ...
        <div className="inner-page__collection inner-page__collection-group">
          ...
          <img
            className="inner-page__collection-8-image"
            src="/assets/images/logo_jewson.png"
            alt="Jewsons logo"
          />
          <img
            className="inner-page__collection-8-image"
            src="/assets/images/logo_The_Link.png"
            alt="The Link logo"
          />
          <img
            className="inner-page__collection-8-image"
            src="/assets/images/logo_currys.png"
            alt="Currys logo"
          />
        </div>
        ...
        <div className="inner-page__collection">
          <img
            className="inner-page__collection-image--first"
            src="/assets/images/bspoke_2022.jpg"
        ...
        <img
          ...
          src="/assets/images/tech-returners-certificate.jpg"
